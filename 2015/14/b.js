...
for (let i = 0; i < 2503; i++) {
  ...
  const furthest = reindeer.sort((a, b) => b.distance - a.distance)[0].distance;

  for (const deer of reindeer) {
    if (deer.distance === furthest) deer.score++;
  }
}

console.log(reindeer, reindeer.sort((a, b) => b.score - a.score)[0]);
